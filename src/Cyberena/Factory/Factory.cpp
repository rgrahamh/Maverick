...
Character* buildCharacter(const char* name, float start_x, float start_y, float start_z, float friction, float mass, RACE race, STYLE style, Stats* stats,
    ...
    player->addHitbox("neutral_up", ELLIPSE, 87, 165, 35, 35, 45, 21, COLLISION | HURTBOX, 0);
    ...
    player->addHitbox("neutral_down", ELLIPSE, 87, 165, 35, 35, 45, 21, COLLISION | HURTBOX, 0);
    ...
    player->addHitbox("neutral_left", ELLIPSE, 87, 165, 35, 35, 45, 21, COLLISION | HURTBOX, 0);
    ...
    player->addHitbox("neutral_right", ELLIPSE, 87, 165, 35, 35, 45, 21, COLLISION | HURTBOX, 0);
    ...
    player->addHitbox("walk_up", ELLIPSE, 34, 64, 35, 35, 45, 21, COLLISION | HURTBOX, 0, 0);
    player->addSprite("walk_up", "day", "./assets/sprites/old_game_resources/Up_Neutral.bmp");
    player->addHitbox("walk_up", ELLIPSE, 34, 64, 35, 35, 45, 21, COLLISION | HURTBOX, 1, 0);
    player->addSprite("walk_up", "day", "./assets/sprites/old_game_resources/Up_Right_Foot.bmp");
    player->addHitbox("walk_up", ELLIPSE, 34, 64, 35, 35, 45, 21, COLLISION | HURTBOX, 2, 0);
    ...
    player->addHitbox("walk_down", ELLIPSE, 34, 64, 35, 35, 45, 21, COLLISION | HURTBOX, 0, 0);
    player->addSprite("walk_down", "day", "./assets/sprites/old_game_resources/Down_Neutral.bmp");
    player->addHitbox("walk_down", ELLIPSE, 34, 64, 35, 35, 45, 21, COLLISION | HURTBOX, 1, 0);
    player->addSprite("walk_down", "day", "./assets/sprites/old_game_resources/Down_Right_Foot.bmp");
    player->addHitbox("walk_down", ELLIPSE, 34, 64, 35, 35, 45, 21, COLLISION | HURTBOX, 2, 0);
    ...
    player->addHitbox("walk_left", ELLIPSE, 34, 64, 35, 35, 45, 21, COLLISION | HURTBOX, 0, 0);
    player->addSprite("walk_left", "day", "./assets/sprites/old_game_resources/Left_Neutral.bmp");
    player->addHitbox("walk_left", ELLIPSE, 34, 64, 35, 35, 45, 21, COLLISION | HURTBOX, 1, 0);
    player->addSprite("walk_left", "day", "./assets/sprites/old_game_resources/Left_Right_Foot.bmp");
    player->addHitbox("walk_left", ELLIPSE, 34, 64, 35, 35, 45, 21, COLLISION | HURTBOX, 2, 0);
    ...
    player->addHitbox("walk_right", ELLIPSE, 34, 64, 35, 35, 45, 21, COLLISION | HURTBOX, 0, 0);
    player->addSprite("walk_right", "day", "./assets/sprites/old_game_resources/Right_Neutral.bmp");
    player->addHitbox("walk_right", ELLIPSE, 34, 64, 35, 35, 45, 21, COLLISION | HURTBOX, 1, 0);
    player->addSprite("walk_right", "day", "./assets/sprites/old_game_resources/Right_Right_Foot.bmp");
    player->addHitbox("walk_right", ELLIPSE, 34, 64, 35, 35, 45, 21, COLLISION | HURTBOX, 2, 0);
...
Object* buildBackground(const char* name, float start_x, float start_y){
    Object* background = new Object(name, start_x, start_y, 1, 1, 0, 0);
