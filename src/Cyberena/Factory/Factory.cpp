...
Character* buildCharacter(const char* name, float start_x, float start_y, float start_z, float friction, float mass, RACE race, STYLE style, Stats* stats,
    ...
    player->addHitbox("neutral_up", ELLIPSE, 17, 60, 0, 8, 5, 64, COLLISION | HURTBOX, 0);
    ...
    player->addHitbox("neutral_down", ELLIPSE, 17, 54, 0, 8, 5, 64, COLLISION | HURTBOX, 0);
    ...
    player->addHitbox("neutral_left", ELLIPSE, 17, 54, 0, 8, 5, 64, COLLISION | HURTBOX, 0);
    ...
    player->addHitbox("neutral_right", ELLIPSE, 17, 54, 0, 8, 5, 64, COLLISION | HURTBOX, 0);
    ...
    for(int i = 0; i < 3; i++){
        player->addHitbox("walk_right", ELLIPSE, 16, 54, 0, 8, 5, 64, COLLISION | HURTBOX, i);
        player->addHitbox("walk_left", ELLIPSE, 16, 54, 0, 8, 5, 64, COLLISION | HURTBOX, i);
        player->addHitbox("walk_down", ELLIPSE, 16, 54, 0, 8, 5, 64, COLLISION | HURTBOX, i);
        player->addHitbox("walk_up", ELLIPSE, 16, 54, 0, 8, 5, 64, COLLISION | HURTBOX, i);
    }
