...
class UIObjectFrame : public UIElement{
    public:
        UIObjectFrame(const char* name, double view_x_offset, double view_y_offset, double view_width, double view_height, int draw_layer, Object* reference = nullptr, char* border_pattern = "", uint8_t border_types = BORDER_TYPE::ALL_BORDERS, uint16_t border_buff = 0);
        ~UIObjectFrame();
