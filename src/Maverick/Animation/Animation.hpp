...
class Animation{
	public:
		...
		*/
		 ...
		 * @param x_off The X offset for the draw
		 * @param y_off The Y offset for the draw
		 * @param width The width of the draw (-1 if you wish to use the default image size)
		 * @param height The height of the draw (-1 if you wish to use the default image size)
		 */
