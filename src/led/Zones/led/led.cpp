...
void buildEditor(){
    ...
    UITextBox* status_bar = new UITextBox("status_bar", 0.1, 0.97, 0.7, 0.03, 1, "cybfont", "Ready", 0.0, 1);
    ...
    UITextBox* tool_selection = new UITextBox("tool_select", 0.8, 0.97, 0.2, 0.03, 1, "cybfont", "Select", 0.0, 1);
