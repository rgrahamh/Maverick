...
void buildEditor(){
    ...
    UITextBox* zone_name = new UITextBox("zone_name", 0, 0, 0.1, 0.075, 1, "./assets/fonts/luximr.ttf", "Zone Placeholder", 0, 24, ALIGNMENT::CENTER, ALIGNMENT::CENTER, "./assets/sprites/ui/basic_border");
    ...
    UITextBox* object_list = new UITextBox("object_list", 0, 0.075, 0.1, 0.85, 1, "./assets/fonts/luximr.ttf", "Objects in zone:", 0, 20, ALIGNMENT::NORMAL, ALIGNMENT::NORMAL, "./assets/sprites/ui/basic_border", BORDER_TYPE::ALL_BORDERS, 14);
    ...
    UITextBox* layer_display = new UITextBox("draw_layer_display", 0, 0.925, 0.1, 0.075, 1, "./assets/fonts/luximr.ttf", "All draw layers", 0.0, 12, ALIGNMENT::CENTER, ALIGNMENT::CENTER, "./assets/sprites/ui/basic_border");
    ...
    UITextBox* status_bar = new UITextBox("status_bar", 0.1, 0.97, 0.7, 0.03, 1, "./assets/fonts/luximr.ttf", "Ready", 0.0, 12);
    ...
    UITextBox* tool_selection = new UITextBox("tool_select", 0.8, 0.97, 0.2, 0.03, 1, "./assets/fonts/luximr.ttf", "Select", 0.0, 12);
    ...
    UITextBox* object_attr = new UITextBox("object_attr", 0.8, 0.2, 0.2, 0.77, 1, "./assets/fonts/luximr.ttf", "Selected object attributes", 0.0, 20, ALIGNMENT::NORMAL, ALIGNMENT::NORMAL, "./assets/sprites/ui/basic_border", BORDER_TYPE::ALL_BORDERS, 14);
