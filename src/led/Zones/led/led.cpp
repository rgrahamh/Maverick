...
void buildEditor(){
    ...
    zone_name->addSprite(0, "./assets/sprites/ui/blue_box_small.bmp");
    ...
    object_list->addSprite(0, "./assets/sprites/ui/blue_box_small.bmp");
    ...
    layer_display->addSprite(0, "./assets/sprites/ui/blue_box_small.bmp");
    ...
    for(int i = 0; i < 10; i++){
        ...
        status_bar->addSprite(0, "./assets/sprites/ui/black.bmp");
    ...
    tool_selection->addSprite(0, "./assets/sprites/ui/black.bmp");
    ...
    object_attr->addSprite(0, "./assets/sprites/ui/blue_box_small.bmp");
