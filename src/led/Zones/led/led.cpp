...
void buildEditor(){
    ...
    zone_name->addAnimationFrame("background", 0);
    ...
    object_list->addAnimationFrame("background", 0);
    ...
    layer_display->addAnimationFrame("background", 0);
    ...
    for(int i = 0; i < 10; i++){
        ...
        hotbar->addAnimationFrame("background", 0);
    ...
    status_bar->addAnimationFrame("background", 0);
    ...
    tool_selection->addAnimationFrame("background", 0);
    ...
    object_attr->addAnimationFrame("background", 0);
