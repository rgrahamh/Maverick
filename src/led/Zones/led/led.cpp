...
void buildEditor(){
    ...
    UITextBox* zone_name = new UITextBox("zone_name", 0, 0, 0.1, 0.075, 1, "./assets/fonts/BitPotionExt.ttf", "Zone Placeholder", 0, 6, ALIGNMENT::CENTER, ALIGNMENT::CENTER, "./assets/sprites/ui/basic_border");
    ...
    UITextBox* object_list = new UITextBox("object_list", 0, 0.075, 0.1, 0.85, 1, "./assets/fonts/BitPotionExt.ttf", "Objects in zone:", 0, 14, ALIGNMENT::NORMAL, ALIGNMENT::NORMAL, "./assets/sprites/ui/basic_border", BORDER_TYPE::ALL_BORDERS, 4);
    ...
    UITextBox* layer_display = new UITextBox("draw_layer_display", 0, 0.925, 0.1, 0.075, 1, "./assets/fonts/BitPotionExt.ttf", "All draw layers", 0.0, 14, ALIGNMENT::CENTER, ALIGNMENT::CENTER, "./assets/sprites/ui/basic_border");
    ...
    for(int i = 0; i < 10; i++){
        ...
        hotbar_name[7] = 0;
        UIObjectFrame* hotbar = new UIObjectFrame(hotbar_name, 0.1 + (i * 0.07), 0.925, 0.07, 0.045, 1, nullptr, "./assets/sprites/ui/basic_border", BORDER_TYPE::ALL_BORDERS, 14);
    ...
    UITextBox* status_bar = new UITextBox("status_bar", 0.1, 0.97, 0.7, 0.03, 1, "./assets/fonts/BitPotionExt.ttf", "Ready", 0.0, 14);
    ...
    UITextBox* tool_selection = new UITextBox("tool_select", 0.8, 0.97, 0.2, 0.03, 1, "./assets/fonts/BitPotionExt.ttf", "Select", 0.0, 14);
    ...
    UITextBox* object_attr = new UITextBox("object_attr", 0.8, 0.2, 0.2, 0.77, 1, "./assets/fonts/BitPotionExt.ttf", "Selected object attributes", 0.0, 14, ALIGNMENT::NORMAL, ALIGNMENT::NORMAL, "./assets/sprites/ui/basic_border", BORDER_TYPE::ALL_BORDERS, 4);
