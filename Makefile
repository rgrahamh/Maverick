INCLUDE_SDL= -lSDL2 -lSDL2_image -lSDL2_ttf -lSDL2_mixer -lGL
CC=g++
...
UI= ./src/Maverick/Entity/UI/UIElement.cpp ./src/Maverick/Entity/UI/UIBorders/UIBorders.cpp ./src/Maverick/Entity/UI/UIText/UIText.cpp ./src/Maverick/Entity/UI/UITextBox/UITextBox.cpp ./src/Maverick/Entity/UI/UIScreenBlit/UIScreenBlit.cpp ./src/Maverick/Entity/UI/UIObjectFrame/UIObjectFrame.cpp
